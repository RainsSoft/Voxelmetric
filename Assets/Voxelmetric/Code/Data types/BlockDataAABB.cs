...
namespace Voxelmetric.Code.Data_types
{
    ...
    public struct BlockDataAABB : IEquatable<BlockDataAABB>
    {
        ...
        public int MinX { get { return (sbyte)(data & 0xFF); } }

        public int MinY { get { return (sbyte)((data >> 8) & 0xFF); } }

        public int MinZ { get { return (sbyte)((data >> 16) & 0xFF); } }

        public int MaxX { get { return (sbyte)((data >> 24) & 0xFF); } }

        public int MaxY { get { return (sbyte)((data >> 32) & 0xFF); } }

        public int MaxZ { get { return (sbyte)((data >> 40) & 0xFF); } }

        public ushort Data { get { return (ushort)(data >> 48); } }
