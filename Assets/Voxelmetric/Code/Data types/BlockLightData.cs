...
namespace Voxelmetric.Code.Data_types
{
    public struct BlockLightData : IEquatable<BlockLightData>
    {
        ...
        public BlockLightData(short lightMask)
        {
            mask = lightMask;
        }
        ...
        public int SwAO { get { return (mask & 0x03); } }

        public int NwAO { get { return (mask & 0x0C) >> 2; } }

        public int NeAO { get { return (mask & 0x30) >> 4; } }

        public int SeAO { get { return (mask & 0xC0) >> 6; } }

        public bool FaceRotationNecessary { get { return ((mask >> 8) & 1) != 0; } }
