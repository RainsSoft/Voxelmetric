...
{
    public class ChunkEvent : IEventSource<ChunkState>, IEventListener<ChunkState>, IEventSource<ChunkStateExternal>
    {
        ...
        private readonly Dictionary<ChunkStateExternal, List<IEventListener<ChunkStateExternal>>> listenersExternal;
        private readonly ChunkEvent[] listeners;
        //! List of chunk listeners
        public ChunkEvent[] Listeners { get { return listeners; } }

        protected ChunkEvent()
        {
            listeners = Helpers.CreateArray1D<ChunkEvent>(6);
            listenersExternal = new Dictionary<ChunkStateExternal, List<IEventListener<ChunkStateExternal>>>
            {
        ...
        public void Clear()
        {
            ...
            foreach (var pair in listenersExternal)
                pair.Value.Clear();
        }
        ...
        public bool Subscribe(IEventListener<ChunkStateExternal> listener, ChunkStateExternal evt, bool register)
        {
            ...
            listenersExternal.TryGetValue(evt, out evtListeners);
