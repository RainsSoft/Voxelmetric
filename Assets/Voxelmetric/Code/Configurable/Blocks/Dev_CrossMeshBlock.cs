...
{
    public class Dev_CrossMeshBlock : Dev_Block
    {
        private const float CEOF = 1.0f / 64.0f;

        public TextureCollection Texture { get { return null; } }
