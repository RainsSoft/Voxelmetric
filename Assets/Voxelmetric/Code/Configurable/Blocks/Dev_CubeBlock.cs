...
{
    public class Dev_CubeBlock : Dev_Block
    {
        public BlockTextures Textures { get { return m_Config.Textures; } }
        public TextureCollection[] TextureCollection { get { return m_Config.TextureCollection; } }
        ...
        public override void BuildFace(Chunk chunk, Vector3[] vertices, ref BlockFace face, bool rotated)
        {
            ...
            BlockUtils.PrepareTexture(chunk, ref face.pos, vertexData, face.side, TextureCollection, rotated);
